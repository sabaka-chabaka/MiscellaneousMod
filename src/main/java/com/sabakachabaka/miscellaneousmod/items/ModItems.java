...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> TITANIUM_CLUSTER = ITEMS.register("titanium_cluster", () -> new BlockItem(ModBlocks.DESH_BLOCK.get(), new Item.Properties().fireResistant().tab(MiscellaneousMod.ORE_GROUP)));
