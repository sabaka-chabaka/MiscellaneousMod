...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> DESH_BLOCK = ITEMS.register("desh_block", () -> new BlockItem(ModBlocks.DESH_BLOCK.get(), new Item.Properties().fireResistant().tab(MiscellaneousMod.BUILDING_GROUP)));
    public static final RegistryObject<BlockItem> TITANIUM_CLUSTER = ITEMS.register("titanium_cluster", () -> new BlockItem(ModBlocks.TITANIUM_CLUSTER.get(), new Item.Properties().fireResistant().tab(MiscellaneousMod.ORE_GROUP)));
    public static final RegistryObject<BlockItem> IRON_CLUSTER = ITEMS.register("iron_cluster", () -> new BlockItem(ModBlocks.IRON_CLUSTER.get(), new Item.Properties().fireResistant().tab(MiscellaneousMod.ORE_GROUP)));
